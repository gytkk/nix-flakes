...
local p = {
  ...
  syntax_string_escape = "#427b58",
  syntax_number = "#c18401",
  syntax_constant = "#c18401",
  syntax_keyword = "#d65d0e",
  syntax_operator = "#383a42",
  syntax_variable = "#383a42",
  syntax_parameter = "#383a42",
  syntax_property = "#e45649",
  syntax_field = "#e45649",
  syntax_func = "#0184bc",
  syntax_method = "#0184bc",
  syntax_type = "#c18401",
  syntax_class = "#c18401",
  syntax_interface = "#c18401",
  syntax_namespace = "#e45649",
  syntax_builtin = "#427b58",
  syntax_tag = "#e45649",
  syntax_attribute = "#c18401",
