...
let
  ...
  oneHalfLightSkin = pkgs.writeText "hermes-one-half-light.yaml" ''
    ...
    colors:
      ...
      completion_fg: "#383a42"
      completion_bg: "#f5f5f5"
      completion_current_fg: "#383a42"
      completion_current_bg: "#bfceff"
      completion_meta_fg: "#4f525e"
      completion_meta_bg: "#f5f5f5"
      completion_current_meta_fg: "#0184bc"
      completion_current_meta_bg: "#bfceff"
