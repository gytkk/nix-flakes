...
- Diagnostics use Tiny Inline's modern preset with single color-coded circle icons, conditional source labels, highlighted line numbers, and rounded detail popups
