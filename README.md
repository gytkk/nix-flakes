...
- Pi and Codex Agents entries display subagent names, models, and activity. Codex also shows lifecycle status markers and a running count, including direct subagents working in the background. See [subagents](modules/herdr/README.md#subagents) for the display limits, and the [Pi extension](modules/pi/README.md#herdr-subagent-sidebar) or [Codex hook and watcher](modules/codex/README.md#herdr-subagent-sidebar) for setup and verification.
