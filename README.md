...
- Agents entries show the agent name and reported model on their second row. Pi and Codex also display subagent names, models, and activity. Codex shows lifecycle status markers and excerpts of recent assistant messages, including direct subagents working in the background. See [subagents](modules/herdr/README.md#subagents) for model reporting and display limits, and the [Pi extension](modules/pi/README.md#herdr-subagent-sidebar) or [Codex hook and watcher](modules/codex/README.md#herdr-subagent-sidebar) for setup and verification.
