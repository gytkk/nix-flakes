...
- Pi's Agents entry displays foreground subagent names, models, and activity through a local Pi extension. See [Pi subagents](modules/herdr/README.md#pi-subagents) for the display limits and [the Pi extension](modules/pi/README.md#herdr-subagent-sidebar) for setup and verification.
